...
export default function Logo(props : LogoProps) {
    ...
    return (
        ...
        // <svg version="1.1" id="Layer_1" xmlBase="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        //     width={`${width}px`} height={`${height}px`} viewBox={`0 0 1000 1000`} enableBackground={`new 0 0 ${width} ${height}`} xmlSpace="preserve">
