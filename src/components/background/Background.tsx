...
export default function Background() {
    return (
        <div className={"background"}>
            <Rectangle width={3} height={"100vh"} color={"#51B14A"} className={'keyakiRect'}></Rectangle>
            <Rectangle width={4} height={"100vh"} color={"#5BBEE4"} className={'hinataRect'}></Rectangle>
            <Rectangle width={2} height={"100vh"} color={"#7C32A2"} className={'nogiRect'}></Rectangle>
