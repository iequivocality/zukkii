...
const Balloon : React.FC<BalloonProps> = (props : BalloonProps) => {
    ...
    return (
        <svg version="1.1" className={className} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            width={`${newWidth}px`} height={`${newWidth * 2}px`} viewBox="0 0 500 1000" enableBackground="new 0 0 500 1000" xmlSpace="preserve">
            <g>
                <path fill="none" stroke="#FFFFFF" strokeWidth="4.5499" strokeMiterlimit="10">
                ...
                <path fill="none" stroke="#FFFFFF" strokeWidth="12.133" strokeLinecap="round" strokeMiterlimit="10" d="M127.714,202.484
